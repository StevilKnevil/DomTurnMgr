  ...
  class NationDetails
  {
    ...
    public static NationDetails Get(int key)
    {
      if (lookup == null)
      {
        ...
        // MIddle Ages
        lookup[43] = new NationDetails("Arcoscephale", "The Old Kingdom", "mid_arcoscephale");
        lookup[44] = new NationDetails("Ermor", "Ashen Empire", "mid_ermor");
        lookup[45] = new NationDetails("Sceleria", "Reformed Empire", "mid_sceleria");
        lookup[46] = new NationDetails("Pythium", "Emerald Empire", "mid_pythium");
        lookup[47] = new NationDetails("Man", "Tower of Avalon", "mid_man");
        lookup[48] = new NationDetails("Eriu", "Last of the Tuatha", "mid_eriu");
        lookup[49] = new NationDetails("Ulm", "Forges of Ulm", "mid_ulm");
        lookup[50] = new NationDetails("Marignon", "Fiery Justice", "mid_marignon");
        lookup[51] = new NationDetails("Mictlan", "Reign of the Lawgiver", "mid_mictlan");
        lookup[52] = new NationDetails("T’ien Ch’i", "Imperial Bureaucracy", "mid_tienchi");
        lookup[53] = new NationDetails("Machaka", "Reign of Sorcerors", "mid_machaka");
        lookup[54] = new NationDetails("Agartha", "Golem Cult", "mid_agartha");
        lookup[55] = new NationDetails("Abysia", "Blood and Fire", "mid_abysia");
        lookup[56] = new NationDetails("Caelum", "Reign of the Seraphim", "mid_caelum");
        lookup[57] = new NationDetails("C’tis", "Miasma", "mid_ctis");
        lookup[58] = new NationDetails("Pangaea", "Age of Bronze", "mid_pangaea");
        lookup[59] = new NationDetails("Asphodel", "Carrion Woods", "mid_asphodel");
        lookup[60] = new NationDetails("Vanheim", "Arrival of Man", "mid_vanheim");
        lookup[61] = new NationDetails("Jotunheim", "Iron Woods", "mid_jotunheim");
        lookup[62] = new NationDetails("Vanarus", "Land of the Chuds", "mid_vanarus");
        lookup[63] = new NationDetails("Bandar Log", "Land of the Apes", "mid_bandarlog");
        lookup[64] = new NationDetails("Shinuyama", "Land of the Bakemono", "mid_shinuyama");
        lookup[65] = new NationDetails("Ashdod", "Reign of the Anakim", "mid_ashdod");
        lookup[66] = new NationDetails("Uruk", "City States", "mid_uruk");
        lookup[67] = new NationDetails("Nazca", "Kingdom of the Sun", "mid_nazca");
        lookup[68] = new NationDetails("Xibalba", "Flooded Caves", "mid_xibalba");
        lookup[73] = new NationDetails("Atlantis", "Kings of the Deep", "mid_atlantis");
        lookup[74] = new NationDetails("R’lyeh", "Fallen Star", "mid_rlyeh");
        lookup[75] = new NationDetails("Pelagia", "Triton Kings", "mid_pelagia");
        lookup[76] = new NationDetails("Oceania", "Mermidons", "mid_oceania");
        lookup[77] = new NationDetails("Ys", "Morgen Queens", "mid_ys");
        // Late Ages
